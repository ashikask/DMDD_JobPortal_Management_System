...
EXEC JOB_APPLICATION_PACKAGE.APPLICATION_DETAILS('APPLIED', TO_DATE('2023-02-09', 'YYYY-MM-DD'),  106, 106);
EXEC POST_JOB_PACKAGE.APPLICATION_DETAILS('HIRED', TO_DATE('2023-02-12', 'YYYY-MM-DD'),  101, 106);
/

INSERT INTO APPLICATION_TRACKING ( STATUS, CHANGED_ON, MODIFIED_BY, APPLICATION_ID)
values ( 'APPLIED', TO_DATE('2/10/2023', 'MM/DD/YYYY'), user, 322 );
INSERT INTO APPLICATION_TRACKING ( STATUS, CHANGED_ON, MODIFIED_BY, APPLICATION_ID)
values (  'INTERVIEW_SCHEDULED', TO_DATE('2/23/2023', 'MM/DD/YYYY'), user, 322 );
INSERT INTO APPLICATION_TRACKING ( STATUS, CHANGED_ON, MODIFIED_BY, APPLICATION_ID)
values (  'APPLIED', TO_DATE('1/13/2023', 'MM/DD/YYYY'), user, 323 );
INSERT INTO APPLICATION_TRACKING ( STATUS, CHANGED_ON, MODIFIED_BY, APPLICATION_ID)
values (  'INTERVIEW_SCHEDULED', TO_DATE('1/28/2023', 'MM/DD/YYYY'), user, 323 );
INSERT INTO APPLICATION_TRACKING ( STATUS, CHANGED_ON, MODIFIED_BY, APPLICATION_ID)
values (  'APPLIED', TO_DATE('2/1/2023', 'MM/DD/YYYY'), user, 324 );
INSERT INTO APPLICATION_TRACKING ( STATUS, CHANGED_ON, MODIFIED_BY, APPLICATION_ID)
values (  'APPLIED', TO_DATE('1/1/2023', 'MM/DD/YYYY'), user, 325 );
INSERT INTO APPLICATION_TRACKING ( STATUS, CHANGED_ON, MODIFIED_BY, APPLICATION_ID)
values (  'APPLIED', TO_DATE('11/11/2022', 'MM/DD/YYYY'), user, 331 );
INSERT INTO APPLICATION_TRACKING ( STATUS, CHANGED_ON, MODIFIED_BY, APPLICATION_ID)
values ( 'APPLIED', TO_DATE('12/17/2022', 'MM/DD/YYYY'), user, 327 );
INSERT INTO APPLICATION_TRACKING ( STATUS, CHANGED_ON, MODIFIED_BY, APPLICATION_ID)
values ( 'INTERVIEW_SCHEDULED', TO_DATE('01/12/2023', 'MM/DD/YYYY'), user, 327 );
INSERT INTO APPLICATION_TRACKING ( STATUS, CHANGED_ON, MODIFIED_BY, APPLICATION_ID)
values (  'INTERVIEW_SCHEDULED', TO_DATE('08/12/2022', 'MM/DD/YYYY'), user, 332 );
INSERT INTO APPLICATION_TRACKING ( STATUS, CHANGED_ON, MODIFIED_BY, APPLICATION_ID)
values (  'HIRED', TO_DATE('02/12/2023', 'MM/DD/YYYY'), user, 332);
/
